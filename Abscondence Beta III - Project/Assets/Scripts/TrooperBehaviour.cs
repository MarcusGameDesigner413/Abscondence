...
public class TrooperBehaviour : MonoBehaviour
{
    ...
    void UpdateAlert()
    {
        ...
        if(distance <= attackRadius)
        {
            ...
            if(attackTimerIterator >= attackTimerMax || firstAttack)
            {
                PlayAttackAnimation();
    ...
    void UpdateDowned()
    {
        ...
        //if the navmesh agent is on it should be stopped
    ...
    //triggered when: The enemy has been downed
    ...
    public void EnemyExecutionAnimation()
    {
        ...
        trooperAnimation.SetTrigger("ExecutionAnimation");
